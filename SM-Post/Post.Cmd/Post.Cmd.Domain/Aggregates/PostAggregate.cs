...
public class PostAggregate : AggregateRoot
{
    ...
    public void EditMessage(string message)
    {
        if (!_active)
        {
            throw new InvalidOperationException("You cannnot edit the message of an inactive post.");
        }
    ...
    public void LikePost()
    {
        if (!_active)
        {
            throw new InvalidOperationException("You cannnot like an inactive post.");
        }
    ...
    public void AddComment(string comment, string userName)
    {
        if (!_active)
        {
            throw new InvalidOperationException("You cannnot add a comment to an inactive post.");
        }
    ...
    public void EditComment(Guid commentId, string comment, string userName)
    {
        if (!_active)
        {
            throw new InvalidOperationException("You cannnot edit a comment to an inactive post.");
        }
    ...
    public void RemoveComment(Guid commentId, string userName)
    {
        if (!_active)
        {
            throw new InvalidOperationException("You cannnot remove a comment of an inactive post.");
        }
